...
// import 'package:zefeffete/domain/usecases/account_usecases.dart';
...
// class EditprofileVenueOwner extends StatefulWidget {
//   static const String pageroute = '/editprofilevenueowner';

//   const EditprofileVenueOwner({super.key});

//   @override
//   State<EditprofileVenueOwner> createState() => _EditprofileVenueOwnerState();
// }
...
// late double price_min;
// late double price_max;

// class _EditprofileVenueOwnerState extends State<EditprofileVenueOwner> {
//   bool showVendor = false;
//   final int maxTextLengthdetails = 3000;
//   final int maxTextLengthabout = 400;
...
//               setState(() {
//                 city =
//                     _cityDropdownKey.currentState?.getSelectedCity() ?? 'city';
//                 gender = _genderDropdownKey.currentState?.getSelectedGender() ??
//                     'gender';
//                 category =
//                     _CategoryDropdownKey.currentState?.getSelectedCategory() ??
//                         'category';
//                 wilaya = _wilayaDropdownKey.currentState?.getSelectedWilaya() ??
//                     'wilaya';
...
//                                                               },
//                                                             );
//                                                             city = _cityDropdownKey
//                                                                     .currentState
//                                                                     ?.getSelectedCity() ??
//                                                                 'city';
//                                                             gender = _genderDropdownKey
//                                                                     .currentState
//                                                                     ?.getSelectedGender() ??
//                                                                 'gender';
//                                                             category = _CategoryDropdownKey
//                                                                     .currentState
//                                                                     ?.getSelectedCategory() ??
//                                                                 'category';
//                                                             wilaya = _wilayaDropdownKey
//                                                                     .currentState
//                                                                     ?.getSelectedWilaya() ??
//                                                                 'wilaya';
//                                                             return;
